class petricore::webapp (String $domain_name, String $petricore_pass){
  ...
  apache::vhost { 'prometheus80_to_prometheus443':
    servername      =>  "prometheus.${domain_name}",
    port            => '80',
    redirect_status => 'permanent',
    redirect_dest   => "https://prometheus.${domain_name}/",
    docroot         => false,
    manage_docroot  => false,
    access_log      => false,
    error_log       => false,
